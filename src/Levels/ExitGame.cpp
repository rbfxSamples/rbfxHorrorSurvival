...
void ExitGame::RegisterObject(Context* context) { context->RegisterFactory<ExitGame>(); }
...
void ExitGame::SubscribeToEvents() { SubscribeToEvent(E_UPDATE, URHO3D_HANDLER(ExitGame, HandleUpdate)); }
