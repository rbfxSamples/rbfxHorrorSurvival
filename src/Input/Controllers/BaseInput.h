...
public:
     ...
     */
    virtual ea::string GetActionKeyName(int action) { return ""; };
    ...
    bool IsActionUsed(int action) { return mappedControlToKey_.contains(action); }

    /**
     * Get all action mapping against controls
     */
    ea::hash_map<int, int> GetConfigMap() { return mappedControlToKey_; }

    /**
     * Start the key to action mapping process
     */
    void StartMappingAction(int action) { activeAction_ = action; }
    ...
    void SetInvertX(bool enabled) { invertX_ = enabled; }

    bool GetInvertX() { return invertX_; }

    void SetInvertY(bool enabled) { invertY_ = enabled; }

    bool GetInvertY() { return invertY_; }
    ...
    float GetSensitivityX() { return sensitivityX_; }
    ...
    float GetSensitivityY() { return sensitivityY_; }
...
protected:
    void SetMinSensitivity(float value) { minSensitivity_ = value; }
