...
private:
    ...
    SoundSource3D* CreateNodeSound(Node* node, const ea::string& filename, const ea::string& type);
     ...
     */
    void PlaySound(ea::string filename, ea::string type = "Effect", int index = -1);
